...
class _ModalSheetContentState extends State<ModalSheetContent> {
  ...
  String buttonText = 'ENTER ROLL NO';
  ...
  void validate() {
    if (widget.check) {
      ...
      } else if (int.parse(clothesController.text) > 10) {
        setState(() {
      ...
      if (cardNumberController.text.length != 9) {
        setState(() {
          buttonText = "ENTER VALID ROLL NO";
    ...
    return Container(
      ...
      child: Wrap(
        children: <Widget>[
          ...
          buildTextField(
              Icons.credit_card, 'Roll No.', cardNumberController, context),
          buildTextField(Icons.dehaze, 'Clothes (Max 10)', clothesController, context),
          Padding(
  ...
  checkOut() {
    ...
    createCheckOutPost(post).then((response) {
      if (response.statusCode == 201) {
        ...
        Fluttertoast.showToast(
          msg:
              "Roll No. ${cardNumberController.text} is not checked in.",
          fontSize: 13.0,
          toastLength: Toast.LENGTH_SHORT,
          timeInSecForIos: 1,
        );
        ...
        Fluttertoast.showToast(
          msg: "Roll No. ${cardNumberController.text} is invalid.",
          fontSize: 13.0,
          toastLength: Toast.LENGTH_SHORT,
          timeInSecForIos: 1,
        );
    ...
    return Container(
      ...
      child: Wrap(
        children: <Widget>[
          ...
          buildTextField(
              Icons.credit_card, 'Roll Number', cardNumberController, context),
          Padding(
            padding: const EdgeInsets.only(top: 20.0),
            child: Center(
              child: Container(
